...
SECRET_KEY = "django-insecure-j4exmy4#*-huhw%!veny@y0l-8jw-lktlqta*pz)b(j_fesqc2"
...
AUTHENTICATION_BACKENDS = (
    # Needed to login by username in the Django admin, regardless of django-allauth
